#!/usr/bin/env python3
"""
Download 56px-wide PNG flags for the exact 193-country NTC list used by the demo.
...
2) Run:
   python3 download_flags_56.py kb_ntc_countries_193.json

Outputs:
- flags_56/<cca2>.png
- flags_56_manifest.json
"""
...
FLAG_URL_TMPL = "https://flagcdn.com/56x42/{code}.png"  # 56px wide, 4:3 icons
...
def main() -> None:
    if len(sys.argv) != 2:
        die("Usage: python3 download_flags_56.py kb_ntc_countries_193.json")
    ...
    manifest_path = os.path.join(out_dir, "flags_56_manifest.json")
